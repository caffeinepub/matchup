...
export class Backend implements backendInterface {
    ...
    async createMatch(arg0: string, arg1: string, arg2: string, arg3: string, arg4: bigint): Promise<string> {
        if (this.processError) {
            try {
    ...
    async searchMatchesByLocation(arg0: string): Promise<Array<Match>> {
        if (this.processError) {
            try {
    ...
    async searchMatchesBySport(arg0: string): Promise<Array<Match>> {
        if (this.processError) {
            try {
